...
const motorcycles = [
  {
    id: 1,
    name: 'Black Diamond RS',
    category: 'Спортивный',
    price: '2 450 000',
    image: 'https://cdn.poehali.dev/projects/6d28b7fd-df97-4a5b-a0a9-1527d610f849/files/87ade8a6-8a0b-4116-bd80-220888d20562.jpg',
    power: '200 л.с.',
    speed: '320 км/ч'
  },
  {
    ...
    category: 'Круизер',
    price: '1 890 000',
    image: 'https://cdn.poehali.dev/projects/6d28b7fd-df97-4a5b-a0a9-1527d610f849/files/177f3d83-9a93-44a9-9cda-577f0cf2a9b0.jpg',
    power: '150 л.с.',
    speed: '220 км/ч'
  },
  {
    id: 3,
    name: 'Gold Edition GT',
    category: 'Туристический',
    price: '3 200 000',
    image: 'https://cdn.poehali.dev/projects/6d28b7fd-df97-4a5b-a0a9-1527d610f849/files/f72f7368-cef7-45ec-8f31-24094630fd95.jpg',
    power: '180 л.с.',
    speed: '280 км/ч'
  }
];
...
const reviews = [
  {
    ...
    text: 'Купил Black Diamond RS месяц назад. Это не просто мотоцикл — это произведение искусства. Каждая деталь продумана до мелочей.',
    rating: 5,
    date: '15 ноября 2024'
  },
  {
    ...
    text: 'Platinum Cruiser превзошёл все ожидания. Комфорт, мощность и элегантность в одном. Отличный сервис и профессиональная команда.',
    rating: 5,
    date: '8 ноября 2024'
  }
];
    ...
    <div className="min-h-screen bg-background text-foreground">
      <nav className="fixed top-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-sm border-b border-border">
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <h1 className="text-2xl font-bold text-gradient">MOTO PREMIUM</h1>
            <div className="hidden md:flex gap-8">
              {['home', 'about', 'services', 'catalog', 'reviews', 'delivery', 'contacts'].map((section) => (
                <button
                  key={section}
                  onClick={() => scrollToSection(section)}
                  className="text-sm font-medium hover:text-gold transition-colors uppercase tracking-wider"
                >
        ...
        <div className="container mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-in">
              <Badge className="mb-6 bg-gold/20 text-gold border-gold">Премиум коллекция 2024</Badge>
              <h2 className="text-6xl md:text-7xl font-bold mb-6 leading-tight">
                Роскошь в <span className="text-gradient">каждой детали</span>
              </h2>
              <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                Эксклюзивная коллекция премиальных мотоциклов для ценителей совершенства
              </p>
              <div className="flex gap-4">
                <Button onClick={() => scrollToSection('catalog')} size="lg" className="bg-gold text-background hover:bg-gold/90">
                  Смотреть каталог
                </Button>
                <Button onClick={() => scrollToSection('contacts')} size="lg" variant="outline" className="border-gold text-gold hover:bg-gold/10">
                  Связаться с нами
                </Button>
              </div>
            </div>
            <div className="animate-scale-in">
              <img 
                src="https://cdn.poehali.dev/projects/6d28b7fd-df97-4a5b-a0a9-1527d610f849/files/87ade8a6-8a0b-4116-bd80-220888d20562.jpg"
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <Card key={index} className="p-8 hover:border-gold transition-all duration-300 hover:shadow-lg hover:shadow-gold/20 animate-fade-in" style={{ animationDelay: `${index * 0.1}s` }}>
                <div className="w-16 h-16 bg-gold/10 rounded-full flex items-center justify-center mb-6">
                  <Icon name={service.icon as any} className="text-gold" size={32} />
                </div>
            ...
            {motorcycles.map((moto, index) => (
              <Card key={moto.id} className="overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-2 animate-fade-in" style={{ animationDelay: `${index * 0.15}s` }}>
                <div className="relative overflow-hidden group">
                  ...
                  />
                  <Badge className="absolute top-4 right-4 bg-gold text-background">{moto.category}</Badge>
                </div>
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-3xl font-bold text-gold">{moto.price} ₽</span>
            ...
            <div className="space-y-6 animate-fade-in">
              <Card className="p-6 flex gap-4">
                <div className="w-12 h-12 bg-gold/10 rounded-full flex items-center justify-center flex-shrink-0">
                  <Icon name="Truck" className="text-gold" size={24} />
                </div>
                <div>
              ...
              <Card className="p-6 flex gap-4">
                <div className="w-12 h-12 bg-gold/10 rounded-full flex items-center justify-center flex-shrink-0">
                  <Icon name="Package" className="text-gold" size={24} />
                </div>
                <div>
              ...
              <form className="space-y-4">
                <div>
                  <input 
                    ...
                    className="w-full px-4 py-3 bg-background border border-border rounded-md focus:outline-none focus:border-gold transition-colors"
                  />
                </div>
                <div>
                  <input 
                ...
                <Button className="w-full bg-gold text-background hover:bg-gold/90" size="lg">
                  Отправить заявку
                </Button>
              </form>
            </Card>
      ...
      <footer className="bg-card border-t border-border py-12 px-6">
        <div className="container mx-auto text-center">
          <h2 className="text-2xl font-bold text-gradient mb-4">MOTO PREMIUM</h2>
          <p className="text-muted-foreground mb-6">Роскошь в каждой детали</p>
          <div className="flex justify-center gap-6 mb-6">
            <Icon name="Instagram" className="text-muted-foreground hover:text-gold transition-colors cursor-pointer" size={24} />
            <Icon name="Facebook" className="text-muted-foreground hover:text-gold transition-colors cursor-pointer" size={24} />
            <Icon name="Youtube" className="text-muted-foreground hover:text-gold transition-colors cursor-pointer" size={24} />
          </div>
